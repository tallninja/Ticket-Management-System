...
CREATE TABLE public.events (
    ...
    vip_ticket_price numeric(8,2) NOT NULL,
    regular_ticket_price numeric(8,2) NOT NULL,
...
--
-- Name: roles roles_normalized_name_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.roles
    ADD CONSTRAINT roles_normalized_name_unique UNIQUE (normalized_name);
...
--
-- Name: reservations reservations_event_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reservations
    ADD CONSTRAINT reservations_event_id_foreign FOREIGN KEY (event_id) REFERENCES public.events(id);
